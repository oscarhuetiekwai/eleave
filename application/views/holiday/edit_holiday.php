<ul class="breadcrumb">
  ...
  <li class="active">
    <a href="#"  style="color:white;">Edit Holiday</a>
  </li>
</ul>
	<div class="row-fluid">
		<div class="span12">
		<?php echo form_open('holiday/edit_holiday'); ?>
		...
		<fieldset>
			...
			<div class="controls">
			<input id="title" name="holiday" size="30" type="text" class="span6" value="<?php echo set_value('holiday',$data_records->holiday); ?>" placeholder="Holiday Name"  title="Eg: Holiday Name"  />
			</div>
			</div>
			...
			<div class="controls">
			<input type="text" class="span2" id="holiday_date" name="holiday_date" class="span6" placeholder="Holiday Date"  value="<?php echo set_value('holiday_date',$data_records->date); ?>" class="input-xlarge uneditable-input" readonly="readonly">
			<input type="hidden" name="date" value="<?php echo $data_records->date; ?>" />
			</div>
			</div>
