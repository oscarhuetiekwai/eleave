<ul class="breadcrumb">
  ...
  <li class="active">
    <a href="#" style="color:white;">Add Department</a>
  </li>
</ul>

	<div class="row-fluid">
		<div class="span12">
		<?php echo form_open('user/add_user_department'); ?>
		<fieldset>
		<?php
		...
		<fieldset>
			...
			<div class="controls">
			<input id="title" name="department_name" size="30" type="text"   class="span8" value="<?php echo set_value('department_name'); ?>" placeholder="Department Name"  title="Eg: Department Name"  />
			</div>
			</div>
