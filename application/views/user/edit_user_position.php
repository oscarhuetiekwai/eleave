<ul class="breadcrumb">
  ...
  <li class="active">
    <a href="#" style="color:white;">Edit Position</a>
  </li>
</ul>

	<div class="row-fluid">
		<div class="span12">
		<?php echo form_open('user/edit_user_position'); ?>
		...
		<fieldset>
			...
			<div class="controls">
			<input id="title" name="position_name" size="30" type="text"   class="span8" value="<?php echo set_value('position_name',$data_records->position_name); ?>" placeholder="Position Name"  title="Eg: Position Name"  />
			<input type="hidden" name="position_id" value="<?php echo $data_records->position_id; ?>" />
			</div>
			</div>
		</div>
		<!--end product-->
