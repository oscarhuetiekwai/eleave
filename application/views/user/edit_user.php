<ul class="breadcrumb">
  ...
  <li class="active">
    <a href="#"  style="color:white;">Edit User</a>
  </li>
</ul>
		...
		<fieldset>
			...
			<div class="controls">
				<select name="role" id="chosen_a" data-placeholder="Select Role" class="chzn_a span7">
					...
					<option value="<?php echo $row->role_id; ?>" <?php if($data_records->role_id==$row->role_id){ ?> <?php echo set_select('role', $row->role_id, TRUE); ?> <?php } else { ?> <?php echo set_select('role', $row->role_id); ?> <?php } ?> ><?php echo $row->role_position; ?></option>
					<?php endforeach; ?>
					<?php endif; ?>
				</select>
			</div>
			...
			<div class="controls">
				<select name="position" id="chosen_b" data-placeholder="Select Position" class="chzn_b span7">
					...
					<option value="<?php echo $row->position_id; ?>" <?php if($data_records->position_id==$row->position_id){ ?> <?php echo set_select('position', $row->position_id, TRUE); ?> <?php } else { ?> <?php echo set_select('position', $row->position_id); ?> <?php } ?> ><?php echo $row->position_name; ?></option>
					<?php endforeach; ?>
					<?php endif; ?>
				</select>
			</div>
			...
			<div class="controls">
				<select name="department" id="chosen_c" data-placeholder="Select Department" class="chzn_c span7">
					...
					<option value="<?php echo $row->department_id; ?>" <?php if($data_records->department_id==$row->department_id){ ?> <?php echo set_select('department', $row->department_id, TRUE); ?> <?php } else { ?> <?php echo set_select('department', $row->department_id); ?> <?php } ?> ><?php echo $row->department_name; ?></option>
					<?php endforeach; ?>
					<?php endif; ?>
				</select>
			</div>
			...
			<div class="controls">
			<input id="title" name="username" size="30" type="text"   class="span8" value="<?php echo set_value('username',$data_records->username); ?>" placeholder="Username"  title="Eg: Username"  />
			</div>
			</div>
			...
			<div class="controls">
			<input id="title" name="password" size="30" type="password"   class="span8" value="" placeholder="Password"  title="Eg: Password"  />
			</div>
			</div>
			...
			<div class="controls">
			<input id="title" name="confirm_password" size="30" type="password"   class="span8" value="" placeholder="Confirm Password"  title="Eg: Confirm Password"  />
			</div>
			</div>
			...
			<div class="controls">
			<input id="title" name="email" size="30" type="text"   class="span8" value="<?php echo set_value('email',$data_records->email_address); ?>" placeholder="Email Address"  title="Eg: Email Address"  />
			</div>
			</div>
			...
			<div class="controls">
				<select name="gender" id="chosen_d" data-placeholder="Select Gender" class="chzn_d">
					<option value=""></option>
					<option value="M" <?php if($data_records->gender=="M"){ ?> <?php echo set_select('gender', $data_records->gender, TRUE); ?> <?php } else { ?> <?php echo set_select('gender', $data_records->gender); ?> <?php } ?> >Male</option>
					<option value="F" <?php if($data_records->gender=="F"){ ?> <?php echo set_select('gender', $data_records->gender, TRUE); ?> <?php } else { ?> <?php echo set_select('gender', $data_records->gender); ?> <?php } ?> >Female</option>
				</select>
			</div>
			</div>
			...
			<div class="controls">
			<input id="title" name="mobile_phone" size="30" type="text"   class="span8" value="<?php echo set_value('mobile_phone',$data_records->mobile_phone); ?>" placeholder="Mobile Phone"  title="Eg: Mobile Phone"  />
			<input type="hidden" name="staff_id" value="<?php echo $data_records->staff_id; ?>" />
			</div>
			</div>
			
			<div class=" control-group formSep">
			<label for="input01" class="control-label">Superior *: <a href="#" class="ttip_t" title="Your User Superior" style="text-decoration:none;color:grey;">[?]</a></label>
			<div class="controls">
				<select name="superior" id="chosen_e" data-placeholder="Select Superior" class="chzn_b span7">
					...
					<option value="<?php echo $row->staff_id; ?>" <?php if($data_records->superior_id==$row->staff_id){ ?> <?php echo set_select('superior', $row->staff_id, TRUE); ?> <?php } else { ?> <?php echo set_select('superior', $row->staff_id); ?> <?php } ?> ><?php echo $row->username; ?></option>
					<?php endforeach; ?>
					<?php endif; ?>
				</select>
			</div>
