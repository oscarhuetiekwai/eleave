<ul class="breadcrumb">
  ...
  <li class="active">
	...
	<div class="row-fluid">
		<div class="span12">
		<?php echo form_open('leave/edit_leave_type'); ?>
		...
		<fieldset>
			...
			<div class="controls">
			<input id="title" name="leave_type" size="30" type="text"   class="span8" value="<?php echo set_value('leave_type',$data_records->leave_type); ?>" placeholder="Leave Type"  title="Eg: Leave Type"  />
			<input type="hidden" name="leave_type_id" value="<?php echo $data_records->leave_type_id; ?>" />
			</div>
			</div>
		</div>
		<!--end product-->
